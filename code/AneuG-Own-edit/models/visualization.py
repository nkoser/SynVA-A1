...
def get_fig_advanced(ghd_reconstruct: GHD_Reconstruct, data: Batch, column=4, Title="Meshes",
                     ...
                     sub_w=5, sub_h=3, plot_neck=False):
    """
    ...
    fig, axes = plt.subplots(row, column, subplot_kw={'projection': '3d'}, figsize=(column*sub_w, row*sub_h))
            ...
            if idx < B:
                ...
                if plot_tangent:
                    for k in range(3):
                        ...
                        ax.quiver(start_point[0], start_point[1], start_point[2], tangent_diff[0], tangent_diff[1], tangent_diff[2], color='blue', length=0.1, normalize=True)
