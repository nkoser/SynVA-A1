...
def save_models(generator, optimizer_G, epoch, log_path, cond_keys=None, cond_loss_style=None, apply_norm=None, extra_state=None):
    save_dict = {
...
def plot_wandb(ghd_reconstruct: GHD_Reconstruct, dataset, generator, latent_dim, epoch, device, use_norm=True, withscale=False):
    ...
    ghd_real, ghd_recon = ghd_real[:1], ghd_recon[:1]
