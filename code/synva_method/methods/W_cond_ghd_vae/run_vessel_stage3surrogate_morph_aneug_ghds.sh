...
# normalized scalar aneurysm morphology appended to the condition vector.
set -euo pipefail
...
SAVE_ROOT_W=${SAVE_ROOT_W:-checkpoints/methods_aneug_ghds_refstage1/W_vessel_stage3surrogate_morph}
META=${META:-W_vessel_stage3surrogate_morph_seed${SEED}_$(date +%Y%m%d_%H%M%S)}
LOG=logs/${META}.log
